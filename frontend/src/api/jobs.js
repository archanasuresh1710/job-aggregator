...
export const getJobs = (keyword, source, domain, hideSeen, country, sponsorship) =>
  api.get('/jobs', { params: { keyword, source, domain, hideSeen, country, sponsorship } }).then(r => r.data)
